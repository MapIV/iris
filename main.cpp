...
Eigen::Matrix4f processRecover(const Eigen::Matrix4f& T_)
{
  Eigen::Vector3f pos = T_.topRightCorner(3, 1);

  std::cout << "\033[2J\033[1;1H";  // new page
  std::cout << "\033[1m\033[31m current t_world: \033[0m\033[33m" << pos.transpose() << std::endl;
  ...
  std::cout << "ex)" << pos.x() << " " << pos.y() << " 1.0 0.0[Enter]" << std::endl;
